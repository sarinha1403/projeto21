    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
            ...
            while($tbl = mysqli_fetch_array($retorno))
            {
                ...
                if($cont == 0)
                {
                    // SE O CARRINHO NÃO EXISTE NO BANCO, GERA UM MD5 E INSERE OS ITENS NA TABELA
                ...
                {
                    // SE O CARRINHO EXISTE, CONSULTA O NUMERO DO CARRINHO PARA ADICIONAR ITENS AO CARRINHO
